...
class FoodAndDrinkActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        foodViewModel.drink.observe(this) { foodList ->
            ...
            binding.progressBarDrink.visibility = View.GONE
            foodAdapter.onClickItem = { food, _ ->
                showBottomSheetDialog(
                    food.itemId,
                    food.picUrl,
        ...
        foodViewModel.combo.observe(this) { foodList ->
            ...
            binding.progressBarCombo.visibility = View.GONE
            foodAdapter.onClickItem = { food, _ ->
                showBottomSheetDialog(
                    food.itemId,
                    food.picUrl,
    ...
    private fun updateCartUI() {
        binding.tvTotalPrice.text =
            "$${String.format("%.2f", cartManager.totalPriceOfCart(userId))}"
    ...
    companion object {
        ...
        private const val RESULT_BACK_PRESSED = 1003
    }
}